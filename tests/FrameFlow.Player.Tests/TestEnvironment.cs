...
/// <summary>
/// Locates test corpus files and detects FFmpeg availability for the
/// player integration tests. Mirror of the
/// <c>FrameFlow.Decoding.Tests.TestEnvironment</c> helper — kept
/// local so the test project doesn't depend on another test
...
/// <summary>
/// XUnit fact that is skipped when FFmpeg shared libraries or test
