...
/// via <see cref="Dispatcher.UIThread"/>. Copied from the
/// AvaloniaPlayer example — both players in this process share one
/// provider so their interleaved output lands in a single pane.
/// </summary>
